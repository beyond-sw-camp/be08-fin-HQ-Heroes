...
public class VacationController {
    ...
    @Operation(summary = "대기중 상태의 휴가 쿼터로 조회")
    ...
    public ResponseEntity<String> submitVacation(@RequestBody VacationDTO vacationDTO) {
        try {
            ...
            params.put("receiverId", vacation.getApprover().getEmployeeId());
            ...
            log.debug("Conflict error: {}", e.getReason());
    ...
    public ResponseEntity<String> rejectCancelVacation(@PathVariable Long vacationId) {
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            params.put("receiverId", vacation.getApplicant().getEmployeeId());
    ...
    public ResponseEntity<String> approveVacation(@PathVariable Long vacationId) {
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            params.put("receiverId", vacation.get().getApplicant().getEmployeeId());
    ...
    @Operation(summary = "팀원으 휴가 정보 조회")
    ...
    @Operation(summary = "대기 중인 휴가 요청 삭제")
