  ...
  <div class="grid grid-cols-12 gap-8">
    ...
    <div class="col-span-12 xl:col-span-6">
      <div class="card">
        ...
        <DataTable :value="announcements" :rows="5" :paginator="true" dataKey="noticeId" responsiveLayout="scroll"
          :rowHover="true" selectionMode="single" @row-click="(e) => showNoticeDetail(e.data.noticeId)"
    ...
    <div class="col-span-12 xl:col-span-6">
      <div class="card">
        ...
        <DataTable :value="notifications" :rows="9" :paginator="true" responsiveLayout="scroll" selectionMode="single"
          @row-click="openNotificationModal" removableSort>
          <!-- 시간 컬럼 -->
