<template>
    <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">알림</div>
                <DataTable :value="notifications" :rows="5" :paginator="true" responsiveLayout="scroll" @row-click="openNotificationModal" :rowHover="true" selectionMode="single">
                    <!-- 시간 컬럼 -->
                    <Column style="width: 25%" header="시간">
                        <template #body="slotProps">
                            <span>{{ new Date(slotProps.data.createdAt).toLocaleDateString('ko-KR') }}</span>
                        </template>
                    </Column>
                    ...
                    <!-- 보낸 사람 컬럼 -->
                    <Column field="senderName" header="보낸 사람" style="width: 25%">
                        <template #body="slotProps">
