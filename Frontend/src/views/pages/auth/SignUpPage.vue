...
// Fetch departments, teams, jobs, and positions
...
function validateForm() {
    ...
    if (!selectedJob.value) {
        errors.value.selectedJob = '직무를 선택해주세요.';
        isValid = false;
    }
...
watch(selectedJob, (newValue) => {
    errors.value.selectedJob = !newValue ? '직무를 선택해주세요.' : '';
});
...
<template>
    <div class="form-container">
        ...
        <div class="form-group">
            ...
            <small v-if="errors.selectedJob" class="error-text">{{ errors.selectedJob }}</small>
        </div>
