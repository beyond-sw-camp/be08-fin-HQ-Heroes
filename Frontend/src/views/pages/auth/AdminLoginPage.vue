...
<template>
  <div class="relative flex items-center justify-center min-h-screen bg-surface-50 dark:bg-surface-950">
    ...
    <div
      ...
      <div>
        <label for="adminCode" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">관리자
          코드</label>
        <InputText id="adminCode" type="text" placeholder="관리자 코드를 입력해주세요." class="w-full md:w-[30rem] mb-4"
          v-model="adminCode" />
